    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        ...
        case 3:
          ...
          if (isSemanticVersionLarger(latestVersion, installedVersion)) console.warn("You are not using the latest version of the SDK. Please update it as soon as possible to enjoy the newest features. Most recent version: " + latestVersion);
          _context3.next = 12;
          break;
